...
func printPoktUsage() {
	...
	fmt.Println("    pocket")
	fmt.Println("USAGE:")
	fmt.Println("    meta-provider pocket start")
	fmt.Println("    meta-provider pocket version")
	fmt.Println("    meta-provider pocket validator")
	fmt.Println("    meta-provider pocket balance --addr=0123456789012345678901234567890123456789")
	fmt.Println("    meta-provider pocket status")
	//fmt.Println("    meta-provider pocket custodial")
	...
	//fmt.Println("    meta-provider pocket noncustodial")
